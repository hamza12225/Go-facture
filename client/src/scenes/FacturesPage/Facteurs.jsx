...
function Factures() {
  ...
  function CustomToolbar() {
    ...
    const columns = [
        { field: "id", headerName: "Offre", width: 150 },
        { field: "date", headerName: "No Facture", width: 90 },
        { field: "filed1", headerName: "Compte de facturation", width: 150 },
        {
          field: "en_cours",
        ...
        { field: "filed2", headerName: "Date fin", width: 70 },
        { field: "filed3", headerName: "Montant Abonnement HT", width: 160 },
        { field: "filed4", headerName: "Montant Communications HT", width: 180 },
        { field: "filed5", headerName: "Montant TTC", width: 90 },
        { field: "filed6", headerName: "Total TTC à payer", width: 120 },
        {
          field: "action",
          headerName: "Actions",
          width: 150,
